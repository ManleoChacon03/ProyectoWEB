...
- Create Angular project with ng: `ng new libreriachacon.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`libreriachacon.client.esproj`).
